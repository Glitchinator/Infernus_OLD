                ...
                if (foundTarget)
                {
                    if (Projectile.ai[1] == 0f)
                    {
                        ...
                        if (Main.myPlayer == Projectile.owner)
                        {
                            ...
                            shootVel.Normalize();
                            shootVel *= 16;
                            Projectile.NewProjectile(Projectile.GetSource_NaturalSpawn(), Projectile.Center.X + 40, Projectile.Center.Y, shootVel.X, shootVel.Y, ProjectileID.ShadowFlame, 32, Projectile.knockBack, Main.myPlayer, 0f, 0f);
                            Projectile.ai[1] = 1f;
                        }
                    }
                }
