		...
		public override void AI()
		{
			...
			if (Main.myPlayer == Projectile.owner && Projectile.ai[0] == 2f && Projectile.ai[1] == 0f)
            {
				for (int i = 0; i < NumProjectiles; i++)
				{
					...
					Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ProjectileID.BlackBolt, Projectile.damage, Projectile.knockBack, Main.myPlayer);
					Projectile.ai[1]++;
				}
			}
		}
