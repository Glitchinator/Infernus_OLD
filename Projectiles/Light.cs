...
namespace Infernus.Projectiles
{
	public class Light : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ProjectileID.MagicDagger, Projectile.damage, Projectile.knockBack, Main.myPlayer);
				Projectile.ai[1]++;
			}
		}
	}
